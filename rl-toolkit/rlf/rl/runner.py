    ...
    def save(self, update_iter: int) -> None:
        if (
            ...
            if self.args.alg == 'dpf-deep' or self.args.alg == 'dpf':
                ...
                if self.args.alg != 'bc' and self.args.alg != 'gcpc' and self.args.alg != 'sac' and self.args.alg != 'dp' and self.args.alg != 'ppo' and self.args.alg != 'sac' and self.args.alg != 'iq-learn':
